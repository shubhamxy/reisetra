...
import { closeSnackBar, updateSnackBar, useGlobalDispatch, useGlobalState } from "../../libs/rock/global";

const colors = {
	default: {background: "#f8f8f8", color: "#000"},
	info: {
...
const useStyles = makeStyles<Theme, IStyledProps>(theme => ({
	root: ({type}) => ({
		...
		flex: 1,
		borderRadius: "8px",
		boxShadow: "0px 2px 6px rgba(0, 0, 0, 0.303775)",
	}),
	icon: ({type}) => ({
