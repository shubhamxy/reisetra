...
import { CreateAddressDto, GetAddressesDto, GetAllAddressDto, UpdateAddressDto } from "./dto";
...
export class AddressController {
  ...
  async getAddresses(
    ...
    try {
      const { results, ...meta } = await this.address.getAddresses(query, req.user.id);
