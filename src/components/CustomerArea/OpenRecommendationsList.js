...
const OpenRecommendationsListRoot = styled(`ul`)`
  list-style: none;
  margin: 0;
...
const OpenRecommendationsList = ({ issues }) => (
  <OpenRecommendationsListRoot>
    {issues.map(issue => (
...
OpenRecommendationsList.propTypes = {
  issues: PropTypes.array.isRequired
}

export default OpenRecommendationsList
