          ...
          <Container>
            <Box pt={6.4} pb={6.4} pl={6.4} pr={6.4}>
              <Typography variant={"body1"}>
                ...
                <br /> This website is operated by {config.name}. Throughout the
                site, the terms “we”, “us” and “our” refer to {config.name}.{" "}
                {config.name} offers this website, including all information,
                tools and services available from this site to you, the user,
                conditioned upon your acceptance of all terms, conditions,
                policies and notices stated here. <br /> <br /> By visiting our
                ...
                are browsers, vendors, customers, merchants, and/ or customers
                of content. <br />
                {` `}
                ...
                of residence, or that you are the age of majority in your state
                ...
                notice.
                {` `}
                <br /> We reserve the right at any time to modify or discontinue
                the Service (or any part or content thereof) without notice at
                any time.
                {` `}
                <br /> We shall not be liable to you or to any third-party for
                ...
                {` `}
                <br /> We have made every effort to display as accurately as
                possible the colors and images of our products that appear at
                the store. We cannot guarantee that your computer monitor's
                display of any color will be accurate. <br /> We reserve the
                ...
                on this site is void where prohibited. <br /> We do not warrant
                ...
                contact you as needed. <br /> <br /> For more detail, please
                review our Returns Policy. <br /> <br />
                {` `}
                <Typography variant={"h5"}>
                  SECTION 7 - OPTIONAL TOOLS
                </Typography>{" "}
                <br /> We may provide you with access to third-party tools over
                which we neither monitor nor have any control nor input. <br />{" "}
                ...
                <br /> We may also, in the future, offer new services and/or
                features through the website (including, the release of new
                tools and resources). Such new features and/or services shall
                also be subject to these Terms of Service. <br /> <br />
                {` `}
                <Typography variant={"h5"}>
                  SECTION 8 - THIRD-PARTY LINKS
                </Typography>{" "}
                <br /> Certain content, products and services available via our
                ...
                materials, products, or services of third-parties. <br /> We are
                not liable for any harm or damages related to the purchase or
                ...
                <br /> In no case shall {config.name}, our directors, officers,
                ...
                maximum extent permitted by law. <br /> <br />
                {` `}
                <Typography variant={"h5"}>
                ...
                of any other remaining provisions. <br /> <br />
                {` `}
                <Typography variant={"h5"}>
                ...
                this agreement for all purposes. <br /> These Terms of Service
                are effective unless and until terminated by either you or us.
                You may terminate these Terms of Service at any time by
                notifying us that you no longer wish to use our Services, or
                when you cease using our site. <br /> If in our sole judgment
                ...
                remain liable for all amounts due up to and including the date
                ...
                waiver of such right or provision. <br /> These Terms of Service
                and any policies or operating rules posted by us on this site or
                ...
                Service at any time at this page. <br /> We reserve the right,
                at our sole discretion, to update, change or replace any part of
                ...
                at{" "}
                <Link href={`mailto:${config.contactEmail}`} underline={"none"}>
                  {config.contactEmail}
                </Link>
                .
              </Typography>
