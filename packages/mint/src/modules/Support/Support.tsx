...
const SupportSchema = Yup.object().shape({
  ...
  subject: Yup.string()
    .required("Subject is required. Subject has to be at least 8 characters.")
    .min(8, "Subject is too short - should be 20 chars minimum."),
  ticketId: Yup.string(),
...
function getOrderName(order) {
  ...
  return `Ordered ${order.cart.items.length} items
