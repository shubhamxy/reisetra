...
import { useCancelOrder, useOrder, useOrderInvoice, useUpdateOrder } from "../../libs";
...
export default function OrderCard(orderData) {
  ...
  const Title = () => (
    <Grid xs={12} container justifyContent="center" alignItems="center" spacing={1}>
      ...
      <Grid container item xs={12} md={6} justifyContent="center" alignItems="center" alignContent="center">
        <Grid item xs justifyContent="center" alignItems="center" alignContent="center">
          <Button
            variant="text"
            color="primary"
            size="medium"
      ...
      <Grid xs={12} container>
        <Grid item xs={12} container alignItems="center" justify="center">
          ...
          <Grid item xs={12} container>
            ...
            <Grid item xs={12}>
              <Typography variant="subtitle2">₹{total || 0}</Typography>
            </Grid>
          </Grid>
          {promo && (
            <Grid item xs={12} container>
    ...
    return (
      <Grid xs container>
        <Grid item xs={12}>
          ...
          <Grid item xs={12}>
            <Typography variant="subtitle2">{verified ? <Check /> : <Error />}</Typography>
          </Grid>
          <Grid item xs={12}>
          ...
          <Grid item xs={12}>
            <Typography variant="subtitle2">{promo || 'None'}</Typography>
          </Grid>
          <Grid item xs={12}>
            <Typography variant="caption">Notes</Typography>
          </Grid>
          <Grid item xs={12}>
            <Typography variant="subtitle2">{notes.join(", ") || 'None'}</Typography>
          </Grid>
        </Grid>
  ...
  return (
    <>
      ...
      <Dialog open={openEdit} onClose={handleEditClose} scroll="body" fullWidth>
        <DialogContent>
          <DialogTitle>
            Invoices
          </DialogTitle>
        <DocsPreview 
          data={documents} className={undefined} handleRemoveItem={undefined}        />
        </DialogContent>
        <DialogActions>
          <Box m={2.4}>
              <ButtonGroup>
