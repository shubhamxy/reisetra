...
import { useUserPasswordUpdate, updateSnackBar, useGlobalDispatch, IErrorResponse } from "../../libs";
    ...
    onSubmit: function ({ oldPassword, password }) {
      passwordUpdate.mutate({
        ...
        onSuccess: () => {
          ...
          replace(`/login?redirect_route=${encodeURIComponent(asPath)}`);
        },
          ...
          <Box className={classes.content}>
            ...
            >
              <TextField
                ...
                onBlur={handleBlur}
                error={touched.oldPassword ? !!errors.oldPassword : false}
