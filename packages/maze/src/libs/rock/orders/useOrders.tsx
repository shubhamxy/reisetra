  ...
  return useMutation(getOrderInvoice, {
    ...
    onError: (error) => {
      dispatch(
        updateSnackBar({
          message:
            error["message"] || "Order Invoice request unsuccessfull",
          type: "error",
          open: true,
        })
      );
  ...
  return useMutation(cancelOrder, {
    ...
    onError: (error) => {
      dispatch(
        updateSnackBar({
          message:
            error["message"] || "Order cancellation request unsuccessfull",
          type: "error",
          open: true,
        })
      );
  ...
  return useMutation(updateOrder, {
    ...
    onError: (error) => {
      dispatch(
        updateSnackBar({
          message:
            error["message"] || "Order update request unsuccessfull",
          type: "error",
          open: true,
        })
      );
