      ...
      <Grid container item xs={6} justifyContent="center" alignItems="center" alignContent="center">
        ...
        <Grid item  >
          <Grid item xs={12}>
            {
              fileType === 'images' ? (
                <ImagePreview data={[data]} variant="list" cellWidth={"100px"} cellHeight={'100px'} />
              ) : (
  ...
  const Details = () => (
    <Grid xs={12} container>
      ...
      <Grid container item>
        ...
        <Grid item xs={12}>
          <Typography variant="subtitle2">{active ? <Check /> : <Error />}</Typography>
        </Grid>
        <Grid item xs={12}>
          <Typography variant="caption">Invoice?</Typography>
        </Grid>
        <Grid item xs={12}>
          <Typography variant="subtitle2">{invoice ? <Check /> : <Error />}</Typography>
        </Grid>
        <Grid item xs={12}>
          <Typography variant="caption">
            File Id
