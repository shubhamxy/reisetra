...
export default function ProductDetails({
    ...
    brands?.data?.pages?.forEach((page) => {
        brandsData = brandsData.concat(page.data)
    })

    categories?.data?.pages?.forEach((page) => {
        categoriesData = categoriesData.concat(page.data)
    })

    tags?.data?.pages?.forEach((page) => {
        tagsData = tagsData.concat(page.data)
    })
            ...
            <Grid container spacing={3}>
                <Grid item xs={12}>
                    <TextField
                        ...
                        onBlur={handleBlur}
                        error={touched.slug ? !!errors.slug : false}
                ...
                <Grid item xs={12} sm={6}>
                    <Autocomplete
                        ...
                        id="brand"
                        options={brandsData as { name: string }[]}
          ...
          /> */}
                ...
                <Grid item xs={12} sm={6}>
                    <TextField
                        ...
                        onBlur={handleBlur}
                        error={
                            touched.inventory?.sku
                                ? !!errors.inventory?.sku
                                : false
                        }
                        helperText={
                            touched.inventory?.sku ? errors.inventory?.sku : ''
                        }
                    />
                </Grid>
                <Grid item xs={12}>
