...
export function CreateProduct({ id = null, isUpdate }) {
    const classes = useStyles()
    const [activeStep, setActiveStep] = React.useState(0)
    const product = useProduct(id)
    const update = (product?.data?.data || {}) as any
