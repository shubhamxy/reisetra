...
import { getAllNodesData } from "../../ui/TextEditor";
...
>((theme) => ({
  root: ({ styleIndex, colors }) => ({
    ...
    color:
      colors && colors[0] ? colors[0] : fade(styles[styleIndex % styles.length].color, 0.8),
    background: colors && colors[1] ? colors[1] : styles[styleIndex % styles.length].background,
...
export function GridItem({
  ...
  const images = getAllNodesData(body, "image");
